<?php
	...
	$conf['servers'][0]['desc'] = 'PostgreSQL Prod';

	// Hostname or IP address for server.  Use '' for UNIX domain socket.
	// use 'localhost' for TCP/IP connection on this computer
	$conf['servers'][0]['host'] = 'ec2-54-243-249-154.compute-1.amazonaws.com';
	...
	$conf['servers'][0]['defaultdb'] = 'd43nekpenqueh9';
	...
	$conf['servers'][1]['desc'] = 'PostgreSQL Slave';
	$conf['servers'][1]['host'] = 'ec2-54-235-89-113.compute-1.amazonaws.com';
	$conf['servers'][1]['port'] = 5432;
	$conf['servers'][1]['sslmode'] = 'allow';
	$conf['servers'][1]['defaultdb'] = 'dgfobjh1m5o0d';
